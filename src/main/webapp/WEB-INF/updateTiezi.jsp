	...
	<DIV>
		...
		<DIV>
			&gt;&gt;<B><A href="index">论坛首页</A></B>&gt;&gt; <B><A
				href="list?bid=${bk.bid }">${bk.bname }</A></B>
		</DIV>
		<BR>
		<DIV>
					...
					<TABLE cellSpacing=0 cellPadding=0 align=center>
						<TBODY>
							...
							<TR class=tr3>
								...
								<TH>
									<INPUT style="PADDING-LEFT: 2px; FONT: 14px Tahoma"
										class=input tabIndex=1 size=60 name=title
										value="${tiezi.title }">
								</TH>
							</TR>
							<TR class=tr3>
								...
								<TH colSpan=2>
									<DIV>
										<SPAN>
										 <TEXTAREA style="WIDTH: 500px" tabIndex=2 rows=20
												cols=90 name=content>${tiezi.content }
										 </TEXTAREA>
										</SPAN>

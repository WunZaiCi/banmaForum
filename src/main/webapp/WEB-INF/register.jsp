	...
	<DIV style="MARGIN-TOP: 15px" class=t align=center>
		<FORM onsubmit="return check()" method=post name=regForm
			...
			<BR>用&nbsp;户&nbsp;名 &nbsp; <INPUT class=input tabIndex=1
				maxLength=20 size=35 name=uName tryp="text"> ${msg }
			<BR>密&nbsp;&nbsp;&nbsp;&nbsp;码
			&nbsp; <INPUT class=input tabIndex=2 maxLength=20 size=40
				type=password name=uPass> <BR>重复密码 &nbsp; 
				
				<INPUT
				class=input tabIndex=3 maxLength=20 size=40 type=password
				name=uPass1> 
				<BR>性别 &nbsp; 
				女<INPUT value="女" type=radio
				name=gender> 
				男<INPUT value="男" CHECKED type=radio name=gender>
			<BR>请选择头像 <BR>
			<IMG src="images/1.gif"><INPUT value=1.gif CHECKED type=radio
				name=head> <IMG src="images/2.gif"><INPUT value=2.gif
				type=radio name=head> <IMG src="images/3.gif"><INPUT
				value=3.gif type=radio name=head> <IMG src="images/4.gif"><INPUT
				value=4.gif type=radio name=head> <IMG src="images/5.gif"><INPUT
				value=5.gif type=radio name=head> <BR>
			...
			<IMG src="images/10.gif"><INPUT value=10.gif type=radio
				name=head> <BR>
			<IMG src="images/11.gif"><INPUT value=11.gif type=radio
				name=head> <IMG src="images/12.gif"><INPUT
				value=12.gif type=radio name=head> <IMG src="images/13.gif"><INPUT
				...
				value=15.gif type=radio name=head> <BR>
